...
namespace {
using NonNullPointerSet = SmallDenseSet<PoisoningVH<Value>, 2>;
...
class LazyValueInfoCache {
  ...
  struct BlockCacheEntry {
    SmallDenseMap<PoisoningVH<Value>, ValueLatticeElement, 4> LatticeElements;
    SmallDenseSet<PoisoningVH<Value>, 4> OverDefined;
