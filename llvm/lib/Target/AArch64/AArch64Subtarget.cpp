...
AArch64Subtarget::AArch64Subtarget(const Triple &TT, StringRef CPU,
    ...
    : AArch64GenSubtargetInfo(TT, CPU, TuneCPU, FS),
      ReserveXRegister(AArch64::RegClass(AArch64::GPR64commonRegClassID)->getNumRegs()),
      ReserveXRegisterForRA(AArch64::RegClass(AArch64::GPR64commonRegClassID)->getNumRegs()),
      CustomCallSavedXRegs(AArch64::RegClass(AArch64::GPR64commonRegClassID)->getNumRegs()),
